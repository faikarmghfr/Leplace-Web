        ...
        <div className="flex flex-col w-screen">
          ...
          <div className="gap-4 pl-10 pr-10 pt-10">
            <div class="w-auto p-6 bg-white border border-gray-200 rounded-lg shadow-md">
              ...
              <button
                type="button"
                class="text-white w-full mt-7 bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                SUBMIT
              </button>
            </div>
